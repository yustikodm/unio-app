...
class Utilitieuni {
  ...
  Utilitieuni(this.name, this.image, this.type, this.description, this.accredition, this.address, this.fasilitas, this.country, this.state,this.district,this.available, this.price,this.rate, this.discount);
