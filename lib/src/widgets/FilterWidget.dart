...
class _FilterWidgetState extends State<FilterWidget> {
  ...
  void getstate(String countryid) async {
    final response = await http.get(
      Uri.parse('https://primavisiglobalindo.net/unio/public/api/states?country_id='+countryid),
      // Send authorization headers to the backend.
      headers: {HttpHeaders.authorizationHeader: "VsNYL8JE4Cstf8gb9LYCobuxYWzIo71bvUkIVYXXVUO4RtvuRxGYxa3TFzsaOeHxxf4PRY7MIhBPJBly4H9bckY5Qr44msAxc0l4"},
    );
    print(response.body);
  ...
  void getCategory() async {
    final response = await http.get(
      Uri.parse('https://primavisiglobalindo.net/unio/public/api/vendor-categories'),
      // Send authorization headers to the backend.
      headers: {HttpHeaders.authorizationHeader: "VsNYL8JE4Cstf8gb9LYCobuxYWzIo71bvUkIVYXXVUO4RtvuRxGYxa3TFzsaOeHxxf4PRY7MIhBPJBly4H9bckY5Qr44msAxc0l4"},
    );
    print(response.body);
              ...
              Expanded(
                child: ListView(
                  ...
                  children: <Widget>[
                        ...
                        child: new DropdownButton(
                          items: category.map((item) {
                            return new DropdownMenuItem(
                              child: new Text((item['name'].toString().length > 30) ? item['name'].toString().substring(0,30):item['name'].toString() ),
                    ...
                    (_categoryGroup=="University" || _categoryGroup=="Majors" || _categoryGroup=="Places to Live" || _categoryGroup=="Vendor" || _categoryGroup=="Scholarship") ? Padding(
                      padding: const EdgeInsets.only(left:20.0),
                      child: Text("Country :"),
                    ):Container(),
                    (_categoryGroup=="University" || _categoryGroup=="Majors" || _categoryGroup=="Places to Live" || _categoryGroup=="Vendor" || _categoryGroup=="Scholarship") ? Padding(
                    ...
                    (_categoryGroup=="Scholarship") ? Padding(
                      padding: const EdgeInsets.only(left:20.0),
                    ...
                    (_categoryGroup=="University" || _categoryGroup=="Majors" || _categoryGroup=="Vendor") ? Padding(
                      padding: const EdgeInsets.only(left:20.0),
                      child: Text("State :"),
                    ):Container(),
                    (_categoryGroup=="University" || _categoryGroup=="Majors" || _categoryGroup=="Vendor") ? Padding(
